...
class MostPopularAdapterList(context: Context, private var mProductList: MutableList<ProductsByCatResponse.OffersBean>
                             , private val mListener: OnMostPopularClicked) : androidx.recyclerview.widget.RecyclerView.Adapter<MostPopularAdapterList.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MostPopularAdapterList.ViewHolder {
    ...
    override fun onBindViewHolder(holder: MostPopularAdapterList.ViewHolder, position: Int) {
