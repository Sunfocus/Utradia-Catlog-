...
class CurrentSaleAdapter(context: Context, private var mProductList: MutableList<FlashSalesResponse.FlashSaleBean.ProductsBean>
                         , private val mListener: OnCurrentSaleItemClicked) : androidx.recyclerview.widget.RecyclerView.Adapter<CurrentSaleAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CurrentSaleAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: CurrentSaleAdapter.ViewHolder, position: Int) {
