...
class RecomendedAdapter(context: Context, private var mProductList: MutableList<RecomendedResponse.OffersBean>
                             , private val mListener: OnRecomendedItemsClicked) : androidx.recyclerview.widget.RecyclerView.Adapter<RecomendedAdapter.ViewHolder>() {
    ...
    fun setItems(mCategoryList: List<RecomendedResponse.OffersBean>){
        mProductList.addAll(mCategoryList)
    }


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecomendedAdapter.ViewHolder {


        val v = LayoutInflater.from(parent.context).inflate(R.layout.view_product_item_list, parent, false)
