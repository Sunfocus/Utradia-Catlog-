...
class ColorsOptionsAdapter(context: Context, private var mColorList: List<ProductDetailResponse.OfferDetailsBean.PricesBean>
                           , private val mListener: OnColorSelected) : androidx.recyclerview.widget.RecyclerView.Adapter<ColorsOptionsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.llThumbnail.setOnClickListener { mListener.onColorSelected(mColorList[pos].color,pos
                ,mColorList[pos].color_name,mColorList[pos].grp_id
                ,mColorList[pos].quantity
