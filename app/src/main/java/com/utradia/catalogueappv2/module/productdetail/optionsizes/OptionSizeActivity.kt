...
class OptionSizeActivity : BaseActivity(), OnSizeOptionSelected,ProductOptionsView {
    ...
    @Inject lateinit var mSizetOptionsPresenter: ProductOptionsPresenter

    private lateinit var mType:String

    private var mQty:Int=0
    private var mAvailableQty:Int?=null
    private lateinit var mSizeAdapter: SizeOptionAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSizetOptionsPresenter.injectDependencies(this)
        mSizetOptionsPresenter.attachView(this)
    ...
    * updating UI from detail response*/
    ...
    private fun updateUI() {
        ...
        if (mType.equals("3",true))
        {
            llColorOptions.visibility= View.GONE
            ...
            if (offerDetails.prices!=null && offerDetails.prices.size>0){
               ...
               // val layoutManager = LinearLayoutManager(this, LinearLayout.HORIZONTAL,false)
                ...
                mSizeAdapter = SizeOptionAdapter(this, offerDetails.prices, offerDetails.prices,this)
               // val animatorAdapter = ScaleInAnimatorAdapter<SizeOptionAdapter.ViewHolder>(mSizeAdapter, rvSizes)
    ...
    override fun onDestroy() {
        ...
        mSizetOptionsPresenter.cancelAllAsync()
        mSizetOptionsPresenter.detachView()
    ...
    companion object {
        ...
        fun createIntent(context: Context): Intent {
            return Intent(context, OptionSizeActivity::class.java)
        }

    }
    override fun onSizeSelected(sizes: List<ProductDetailResponse.OfferDetailsBean.PricesBean>, pos:Int) {
    ...
    private fun addToCart() {
        ...
        if (mAppUtils.isInternetConnected)
        {
            if(response.selectedVariant !=null)
            {
                ...
                mSizetOptionsPresenter.addToCart(mPrefs.userId,mProductId!!
    ...
    private fun buyNowCart() {
        ...
        if (mAppUtils.isInternetConnected)
        {
            if(response.selectedVariant !=null)
            {
                ...
                mSizetOptionsPresenter.buyNowCart(mPrefs.userId,mProductId!!
                        , response.selectedVariant!!.qty
                        , response.offer_details!!.variant_group_type
                        , response.selectedVariant!!.variant_id
                        , response.selectedVariant!!.color
