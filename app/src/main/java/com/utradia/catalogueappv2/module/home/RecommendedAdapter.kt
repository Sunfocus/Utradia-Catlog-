...
class RecommendedAdapter(context: Context, private var mProductList: List<HomeResponse.RecommendedItemsBean>
                         , private val mListener: OnHomeCatClicked) : androidx.recyclerview.widget.RecyclerView.Adapter<RecommendedAdapter.ViewHolder>() {
    ...
    fun setItems(mCategoryList: List<HomeResponse.RecommendedItemsBean>){
    ...
    override fun onBindViewHolder(holder: RecommendedAdapter.ViewHolder, position: Int) {
        ...
        holder.clProductParent.setOnClickListener { mListener.onRecommendedItemClicked(mProductList[pos].id,mProductList[pos].title) }
